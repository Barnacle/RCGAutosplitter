...
state("RiverCityGirls", "Steam 1.1")
{
	...
	byte1 Boss_health_check :		"mono.dll", 0x26ABD8, 0x158, 0x360, 0x10, 0x158, 0x198, 0x348; // UI_HUD_Boss
	int Boss_health :				"mono.dll", 0x26ABD8, 0x158, 0x360, 0x10, 0x158, 0x198, 0x348;

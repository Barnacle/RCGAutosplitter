...
state("RiverCityGirls", "Steam 1.1")
{
	...
	int UI_HUD_Boss :				"UnityPlayer.dll", 0x14D6098, 0x0, 0x628, 0x38, 0x30, 0x4F0, 0x158, 0x0;
	byte1 Boss_health_check :		"UnityPlayer.dll", 0x14D6098, 0x0, 0x628, 0x38, 0x30, 0x4F0, 0x158, 0x58, 0x348;
	int Boss_health :				"UnityPlayer.dll", 0x14D6098, 0x0, 0x628, 0x38, 0x30, 0x4F0, 0x158, 0x58, 0x348;

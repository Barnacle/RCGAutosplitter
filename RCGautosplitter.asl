...
state("RiverCityGirls")
{
	...
	byte1 Boss_health_check :		"UnityPlayer.dll", 0x1511C28, 0x8, 0x20, 0xD0, 0x120, 0x90, 0x1A0, 0xF8, 0x348;
	int Boss_health :				"UnityPlayer.dll", 0x1511C28, 0x8, 0x20, 0xD0, 0x120, 0x90, 0x1A0, 0xF8, 0x348;
